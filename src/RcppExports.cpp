...
// mixsqp_rcpp
List mixsqp_rcpp(const arma::mat& L, const arma::vec& w, const arma::vec& x0, double convtolsqp, double convtolactiveset, double zerothresholdsolution, double zerothresholdsearchdir, double suffdecr, double stepsizereduce, double minstepsize, const arma::vec& eps, double delta, int maxitersqp, int maxiteractiveset, bool verbose);
RcppExport SEXP _mixsqp_mixsqp_rcpp(SEXP LSEXP, SEXP wSEXP, SEXP x0SEXP, SEXP convtolsqpSEXP, SEXP convtolactivesetSEXP, SEXP zerothresholdsolutionSEXP, SEXP zerothresholdsearchdirSEXP, SEXP suffdecrSEXP, SEXP stepsizereduceSEXP, SEXP minstepsizeSEXP, SEXP epsSEXP, SEXP deltaSEXP, SEXP maxitersqpSEXP, SEXP maxiteractivesetSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(mixsqp_rcpp(L, w, x0, convtolsqp, convtolactiveset, zerothresholdsolution, zerothresholdsearchdir, suffdecr, stepsizereduce, minstepsize, eps, delta, maxitersqp, maxiteractiveset, verbose));
