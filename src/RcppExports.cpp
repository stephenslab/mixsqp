...
// mixem_rcpp
arma::vec mixem_rcpp(const arma::mat& L, const arma::vec& w, const arma::vec& x0);
RcppExport SEXP _mixsqp_mixem_rcpp(SEXP LSEXP, SEXP wSEXP, SEXP x0SEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(mixem_rcpp(L, w, x0));
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(mixsqp_rcpp(L, U, V, w, z, x0, usesvd, convtolsqp, convtolactiveset, zerothresholdsolution, zerothresholdsearchdir, suffdecr, stepsizereduce, minstepsize, identitycontribincrease, eps, maxitersqp, maxiteractiveset, verbose));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_mixsqp_mixem_rcpp", (DL_FUNC) &_mixsqp_mixem_rcpp, 3},
