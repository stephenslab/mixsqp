...
mixem_rcpp <- function(L, w, x0, numiter, zerothresholdsolution, verbose) {
    .Call('_mixsqp_mixem_rcpp', PACKAGE = 'mixsqp', L, w, x0, numiter, zerothresholdsolution, verbose)
}

mixem_update_rcpp <- function(L, w, x0) {
    .Call('_mixsqp_mixem_update_rcpp', PACKAGE = 'mixsqp', L, w, x0)
}
